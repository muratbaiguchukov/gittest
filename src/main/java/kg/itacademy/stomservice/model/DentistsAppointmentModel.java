...
@Setter
@NotNull
public class DentistsAppointmentModel {
    ...
    @NotBlank(message = "visit start time can't be blank")
    private LocalTime visitStartTime;

    @NotBlank(message = "visit end time can't be blank")
    private LocalTime visitEndTime;

    @NotEmpty(message = "patient can't be blank")
